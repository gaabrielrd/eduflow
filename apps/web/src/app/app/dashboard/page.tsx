...
export default function DashboardPage() {
  return (
    <section className="space-y-8">
      <PageHeader
        actions={<Badge variant="success">Rota /app/dashboard pronta</Badge>}
        description="O layout foi preparado para receber indicadores, tabelas e fluxos operacionais sem depender de uma grade pesada de cards."
        eyebrow="Dashboard"
        title="Placeholder do painel principal"
      />
      ...
      <EmptyState
        description="Sem dados reais ainda, mas a estrutura ja esta pronta para receber listagens administrativas reutilizando o mesmo pacote UI."
